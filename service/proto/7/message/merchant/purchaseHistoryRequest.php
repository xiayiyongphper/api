...
/**
 * purchaseHistoryRequest message
 */
class purchaseHistoryRequest extends \framework\protocolbuffers\Message
{
    /* Field index constants */
    const customer_id = 1;
    const auth_token = 2;
    const category_id = 3;
    const category_level = 4;
    const pagination = 5;
    ...
    public function reset()
    {
        ...
        $this->values[self::category_level] = self::$fields[self::category_level]['default'];
